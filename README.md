...
- 响应式设计，适配各种屏幕尺寸
- 深色/浅色模式切换（支持自动跟随系统、平滑过渡动画）
- 深色模式配色符合 WCAG 对比度标准
- 文章目录导航（自动生成）
- 阅读进度条
- 图片灯箱（ViewImages）
- Prism 代码高亮（支持 6 种主题切换）
- 关键资源预加载优化
- 后台管理代码高亮主题切换与即时预览
...
- 安全性增强：修复评论区域 XSS 漏洞
- 新增代码高亮主题切换功能（6种主题：默认、Tomorrow Night、Okaidia、Dracula、Solarized Light、GitHub Light）
- 后台管理界面代码高亮主题切换与即时预览功能
- 优化导航栏字体大小，提升可读性
- 深色模式配色优化，符合 WCAG 对比度标准
- 深色/浅色模式切换添加平滑过渡动画
- 新增关键资源预加载优化（CSS、JS、DNS预取）
- 修复弹幕设置配置不生效问题
- 优化主题设置读取逻辑
